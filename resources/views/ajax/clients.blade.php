...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12">
                <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"> Add New Client
                </button>
                <hr>
            </div>
            <div class="col-sm-12">
                        ...
                        <tr id="{{$row->id}}">
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger delete"
                                    data-route="{{url('/delete-client/'.$row->id)}}">Delete <i class="fa fa-times"></i>
                                </button>
                            </td>
                        </tr>
                        @endforeach
